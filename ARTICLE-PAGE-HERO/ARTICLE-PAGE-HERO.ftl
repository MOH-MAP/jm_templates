    ...
    <div class="container">
		<div class="row">
            <div class="jmarticle-hero-content">
				...
				<p class="jmarticle--hero-para"><#if (SubTitle.getData())??>${SubTitle.getData()}</#if></p>
                ...
                <#if Link_Title?? && Link_Title.getData()?has_content>
                    ...
                    <div>
                        <a class="jmarticle--hero-btn" href="${linkHref}">${Link_Title.getData()}
                        <span class="jmarticle--hero-arrow_icon"></span></a>
                    </div>
                </#if>
            </div>
        </div>
