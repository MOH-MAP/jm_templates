<#assign namespace=r andomNamespace />
...
<style>
    ...
    {
        <#if (ImageLarge.getData())?? && ImageLarge.getData() !="">background-image: url("${ImageLarge.getData()!}");
    ...
    @media(min-width: 320px) and (max-width: 539px) {
        ...
        {
            <#if (ImageSmall.getData())?? && ImageSmall.getData() !="">background-image: url("${ImageSmall.getData()!}");
            </#if>height: 463px;
        }
    }
</style>
    ...
    <div class="centered container">
        ...
        <form id="career-search-frm-${namespace}" action="${ResultsPage.getFriendlyUrl()}" autocomplete="off">
            <div class="career__input__sec">
                <div class="dept__sec">
                    <input id="q-${namespace}" name="q" class="career__input" type="text" placeholder="Enter job title, department or other keywords" />
                </div>
