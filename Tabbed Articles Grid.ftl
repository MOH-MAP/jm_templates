    ...
    <div class="row">
        ...
        <#list entries as curEntry>
            <#assign 
				...
				latestUrl = "/web"+siteName+path?keep_after("/sitecore/content/johnson-matthey/Home")
			...
			<#if xPathSelectorAuthor.selectSingleNode(rootElement)??>
				...
				/>
				<#if authJSON.title?? && authJSON.title?has_content>
					<#assign 
            ...
            <div class="tabbed-article-flex-item">
                <a class="tabbed-article-flex-item-link" href=${latestUrl}></a>
                <div class="tabbed-article-thumbnail">
                    ...
                    <div class="tabbed-thumbnail-title">
                        ...
                        <span class="title-date">${formatDate?string["dd MMM yyyy"]}</span>
                    </div>
